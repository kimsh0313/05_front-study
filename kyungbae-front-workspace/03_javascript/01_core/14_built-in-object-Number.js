...
console.log(Number.isFinite(10.31));        // true
...
console.log(Number.parseInt(str));    // 소수점 미만 버림처리

let num = 1.23456;
console.log(num.toFixed());
console.log(num.toFixed(1));
console.log(num.toFixed(3), typeof(num.toFixed(3))); // 자릿수 반올림 후 String 타입으로 반환
...
function getTotal(param) {
  ...
  param.forEach( element => {
    if ((!Number.isNaN(element/1)) && typeof element != 'boolean'){
