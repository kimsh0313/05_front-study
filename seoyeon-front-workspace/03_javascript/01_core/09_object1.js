...
const person = {
  ...
  }, // 프로퍼티 나열은 쉼표로 구분, 후행쉼표(trailing coma) 사용 가능
};
...
const movie = {
  ...
  toString: function() {
    // 메소드 낸에서 현재 객체를 가리키고자 할 경우 this.
    // 단, 화살표 함수 내에서는 this가 제대로 바인딩 되지 않음 => this 대신에 객체명.
    return `제목: ${this.title}, 상영시간: ${this.showTm}분, 개봉일: ${this.openDt}, 감독: ${this.director}`;
  }
};
...
movie['title en'] = 'Xo, Kitty 2';
movie.status = '상영중';
// * 프로퍼티 삭제 : delete 연산자로 객체명.프로퍼티명으로 삭제
delete movie.showTm;
