...
console.log(str.padStart(15, '*')); // str의 길이가 15가 되도록 *를 왼쪽에 채움
console.log(str.padEnd(15, '*')); // str의 길이가 15가 되도록 *를 왼쪽에 채움
...
const testArr = ['yes', 'Yes', 'yEs', 'y', 'Y', 'yes', '  y es', 'Y  es', 'No', '  no'];
