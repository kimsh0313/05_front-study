...
// 조건 || 조건이 거짓일 경우 실행할 구문
num % 2 == 1 || console.log('홀수입니다.');

// * 기본값 설정
//   변수 = 대입할값 || default값;
var name = '' || '이름없음'; // '' 자리가 사용자 입력값이라고 가정, 만일 입력값이 없을 경우 기본값을 대입하고자 할 때
console.log(name);
