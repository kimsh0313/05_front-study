...
hello('정재현'); // 함수 선언문으로 정의한 함수는 호이스팅됨!
hi('정재현');    // 함수 표현식으로 정의한 함수는 호이스팅되지 않음!
...
paramTest();              // 매개변수 수보다 적은 인자 전달시 undefined로 처리됨
...
function welcome(name){
  ...
  console.log(name); // 반환문 이후의 코드는 실행되지 않음
}

let welcomeTxt = welcome('정재현');
